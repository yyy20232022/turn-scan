...
CREATE TABLE `micro_node` (
                              `node_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '节点id',
                              `amount` decimal(65,0) DEFAULT NULL COMMENT '质押金额',
                              `operation_addr` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '操作地址',
                              `beneficiary` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '收益帐户',
                              `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '节点名称',
                              `details` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '节点详细描述',
                              `electron_uri` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '微节点对外提供RPC服务的地址',
                              `p2p_uri` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '节点之间建立p2p连接的信息',
                              `rpc_uri` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '节点对外提供RPC服务的地址',
                              `version` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '程序版本',
...
CREATE TABLE `micro_node_opt_bak` (
                                      ...
                                      `node_id` varchar(130) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '节点id',
                                      `type` int NOT NULL COMMENT '操作类型:1创建,2修改,3退出',
                                      `tx_hash` varchar(72) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '交易hash',
...
CREATE TABLE `addr_game` (
                             `id` bigint NOT NULL AUTO_INCREMENT COMMENT '纪录id',
                             `address` varchar(42) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '地址',
                             `round_id` bigint DEFAULT NULL COMMENT '回合id',
                             `game_id` bigint DEFAULT NULL COMMENT '游戏id',
                             `game_contract_address` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '游戏合约地址',
                             `bubble_id` bigint DEFAULT '0' COMMENT '所属bubble_id:0-未组建bubble',
                             `status` int DEFAULT NULL COMMENT '游戏状态:1-开始；0-结束',
                             `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
                             `update_time` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
...
CREATE TABLE `game` (
                        ...
                        `contract_address` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '合约地址',
                        `name` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '游戏名称',
                        `website` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '游戏网址',
                        `introduce` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '游戏介绍',
                        `game_type` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '游戏类型',
...
CREATE TABLE `round` (
                         ...
                         `game_id` bigint DEFAULT NULL COMMENT '游戏id',
                         `round_id` bigint DEFAULT NULL COMMENT '回合id',
                         `bubble_id` bigint DEFAULT NULL COMMENT '子网络id',
                         `creator` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '回合创建地址',
