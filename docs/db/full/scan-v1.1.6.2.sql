...
CREATE TABLE `micro_node` (
                              ...
                              `operation_addr` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '操作地址',
                              `beneficiary` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '收益帐户',
                              `name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '节点名称',
                              `details` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '节点详细描述',
                              `electron_uri` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '对外提供RPC服务的地址',
                              `p2p_uri` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '节点之间建立p2p连接的信息',
                              `version` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '程序版本',
                              ...
                              `bubble_creator` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'bubble创建者',
                              `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
